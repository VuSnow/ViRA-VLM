...
class SentenceEmbeddingRetrieval(nn.Module):
    def __init__(self, model_name="dangvantuan/vietnamese-embedding", tokenizer_path="/workspace/Vi-VLM-TTDN/modules/vncorenlp", device=None, is_loaded=False):
    ...
    @torch.no_grad()
    def encode(self, question, tokenize_text=True):
